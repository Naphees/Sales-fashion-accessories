...
require('connection.php');
 class order 
   ...
   $ob=new order();
   $ob->sql="SELECT * FROM  produce_order WHERE customer = '".$_SESSION['id']."' && order_complete IS NULL";
...
<div class="container-fluid">
    ...
    <?php
	 ...
	 <td>
		<b><i><a href="order_current_produce.php?id=<?php echo $ob->row['id'];  ?>">     Produce list  </a>  </i></b>
	  </td>
      </tr>
